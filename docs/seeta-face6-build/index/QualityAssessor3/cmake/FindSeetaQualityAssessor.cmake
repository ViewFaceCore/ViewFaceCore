# =============== Edit here ==================== #
set(_TARGET_NAME "SeetaQualityAssessor")
set(_TARGET_VERSION_MAJOR "3")
set(_TARGET_VERSION_MINOR "0")
set(_TARGET_VERSION_SINOR "0")
set(_TARGET_HEADER "QualityAssessor.h")
# =============== Edit end ===================== #
...
if(BUILD_ANDROID)
	...
	if("${LIBRARY_RELEASE}" STREQUAL "")
        ...
        message(STATUS "${_TARGET_NAME} lib path: " ${${_TARGET_NAME}_MODULE_PATH}${ENV_LIBRARY_DIR})
	...
	find_library(${_TARGET_NAME}_LIBRARY_DEBUG
			...
			${${_TARGET_NAME}_MODULE_PATH}${ENV_LIBRARY_DIR}
