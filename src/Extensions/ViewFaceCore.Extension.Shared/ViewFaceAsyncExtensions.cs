...
namespace ViewFaceCore
{
    ...
    public static class ViewFaceAsyncExtensions
    {
        ...
        public static async Task<FaceInfo[]> DetectAsync<T>(this FaceDetector viewFace, T image) where T : class
            => await Task.Run(() => viewFace.Detect(image));
        ...
        /// <returns></returns>
        public static async Task<float[]> ExtractAsync<T>(this FaceRecognizer viewFace, T image, FaceMarkPoint[] points) where T : class
            => await Task.Run(() => viewFace.Extract(image, points));
        ...
        /// <returns></returns>
        public static async Task<QualityResult> DetectAsync<T>(this FaceQuality viewFace, T image, FaceInfo info, FaceMarkPoint[] points, QualityType type) where T : class
            => await Task.Run(() => viewFace.Detect(image, info, points, type));
        ...
        public static async Task<int> PredictAgeAsync<T>(this AgePredictor viewFace, T image, FaceMarkPoint[] points) where T : class
            => await Task.Run(() => viewFace.PredictAge(image, points));
        ...
        public static async Task<Gender> PredictGenderAsync<T>(this GenderPredictor viewFace, T image, FaceMarkPoint[] points) where T : class
            => await Task.Run(() => viewFace.PredictGender(image, points));
        ...
        /// <param name="points">关键点坐标<para>通过 <see cref="FaceMark(FaceImage, FaceInfo)"/> 获取</para></param>
        /// <returns></returns>
        public static async Task<EyeStateResult> DetectAsync<T>(this EyeStateDetector viewFace, T image, FaceMarkPoint[] points) where T : class
            => await Task.Run(() => viewFace.Detect(image, points));
