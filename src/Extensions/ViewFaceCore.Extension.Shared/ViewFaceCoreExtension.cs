...
namespace ViewFaceCore.Core
{
    public static class ViewFaceCoreExtension
    {
        ...
        public static AntiSpoofingResult AntiSpoofing<T>(this FaceAntiSpoofing viewFace, T image, FaceInfo info, FaceMarkPoint[] points) where T : class
        {
            using (var faceImage = image.ToFaceImage())
            {
        ...
        public static AntiSpoofingResult AntiSpoofingVideo<T>(this FaceAntiSpoofing viewFace, T image, FaceInfo info, FaceMarkPoint[] points) where T : class
        {
            using (var faceImage = image.ToFaceImage())
            {
