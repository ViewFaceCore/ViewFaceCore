...
namespace seeta
{
    ...
    public:
        ...
        ImageData &operator=(self &&other) noexcept
        {
    ...
    public:
        ...
        ModelSetting(self &&other) noexcept
            : supper({ other.device, other.id, nullptr })
        {
        ...
        ModelSetting &operator=(self &&other) noexcept
        {
            this->device = other.device;
            this->id = other.id;
            this->m_model_string = std::move(other.m_model_string);
        ...
        ModelSetting(const std::string &model, Device device, int id) noexcept : self(model, SeetaDevice(device), id) {}
    ...
    public:
        ...
        Buffer &operator=(self &&other) noexcept
        {
    ...
    public:
        ...
        ModelBuffer(self &&other) noexcept
            : supper({ other.device, other.id, nullptr })
        {
        ...
        ModelBuffer &operator=(self &&other) noexcept
        {
            this->device = other.device;
            this->id = other.id;
            this->m_model_buffer = std::move(other.m_model_buffer);
        ...
        ModelBuffer(const seeta::Buffer &buffer, Device device, int id) noexcept : self(buffer, SeetaDevice(device), id) {}
